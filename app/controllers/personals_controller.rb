class PersonalsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @personal.save
        format.html { redirect_to new_employment_path, notice: "Personal was successfully created." }
        format.json { render :show, status: :created, location: @personal }
      else
        format.turbo_stream { redirect_to new_personal_path, status: :unprocessable_entity }
  ...
  def update
    respond_to do |format|
      if @personal.update(personal_params)
        format.html { redirect_to new_employment_path, notice: "Personal was successfully updated." }
  ...
  private
    ...
    def personal_params
      params.require(:personal).permit(:first_name, :last_name, :nick_name, :email_address, :phone_number)
    end
end
